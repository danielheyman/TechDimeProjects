			...
			<div class="row demo-tiles">
				<div class="col-xs-12" >
					{{ Form::model($banner) }}
						...
						<div>
							<label for="enabled">Status: <a style="color: {{ ($banner->enabled) ? '#1abc9c' : '#e74c3c' }}" href="javascript:void(0);" id="enabled">{{ ($banner->enabled) ? "Rotating" : "Paused" }}</a></label>
						...
						<br>
						<div id="hours">
							{{ Form::hidden('hours', implode(",", $banner->hours)) }}
						...
						<br>
						<div id="days">
							{{ Form::hidden('days', implode(",", $banner->days)) }}
						...
						<br>
						<a href="{{ url('banners') }}" class="btn btn-huge btn-info">Go Back</a>
