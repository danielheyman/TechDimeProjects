...
namespace {
    ...
    class User extends \BriskSurf\Users\UserModel{
        
    }


    class SecureForm extends \BriskSurf\SecureForm\SecureFormFacade{
        ...
        public static function create(){
            return \BriskSurf\SecureForm\SecureFormManager::create();
        }
         ...
         */
        public static function check(){
            return \BriskSurf\SecureForm\SecureFormManager::check();
        }
        ...
        public static function image($id, $number){
            return \BriskSurf\SecureForm\SecureFormManager::image($id, $number);
        }
        
    }


    class Settings extends \BriskSurf\Settings\SettingsFacade{
        ...
        public static function get($id){
            //Method inherited from \BriskSurf\Helpers\BaseModelsBank            
            return \BriskSurf\Settings\SettingsBank::get($id);
        }
        ...
        public static function all(){
            //Method inherited from \BriskSurf\Helpers\BaseModelsBank            
            return \BriskSurf\Settings\SettingsBank::all();
        }
        
    }


    class Packages extends \BriskSurf\Payments\PackagesFacade{
        ...
        public static function get($id){
            //Method inherited from \BriskSurf\Helpers\BaseModelsBank            
            return \BriskSurf\Payments\PackagesBank::get($id);
        }
        ...
        public static function all(){
            //Method inherited from \BriskSurf\Helpers\BaseModelsBank            
            return \BriskSurf\Payments\PackagesBank::all();
        }
