...
class Layout 
{
    ...
    public function cleanURL($loggedIn, $site)
    {
        ...
        if(!$loggedIn && file_exists("loggedIn/" . $url[0] . ".php") && $url[0] == "shield") $url[1] = "s-" . $url[1];
        ...
        else $page = "both/error.php";


        //if($loggedIn && $page != "loggedIn/home.php" && $page != "loggedIn/tools.php" && $page != "loggedIn/settings.php" && $page != "both/logout.php") $page = "loggedIn/home.php";
