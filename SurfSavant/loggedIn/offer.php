<?php if($usr->data->registeredOffer != "0") { include 'home.php'; exit; } ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
...
<div class="account-container stacked">
	...
	<div class="content clearfix">
            ...
            <iframe width="640" height="360" src="//www.youtube.com/embed/PEVVb5hJHL4?rel=0&autohide=1&showinfo=0&wmode=transparent&autoplay=1" frameborder="0" allowfullscreen></iframe>
            
            <h2>Save Over 40% On One Full Year!</h2>
            <h3>
            ...
            <h2>Pro Membership Now Only $64</h2>
            <div class="boxing">
                <div class="coloring">Yes!</div> Matt, I want to take advantage of this crazy offer and get a one year pro upgrade. <br><br>
                A <div class="coloring">$44 savings</div> is too good to pass up!<br><br><br>
                <form name="_xclick" action="https://www.paypal.com/cgi-bin/webscr" method="post">
                    <input type="hidden" name="cmd" value="_xclick-subscriptions">
                    <input type="hidden" name="a3" value="<?=$packages[11]["price"]?>">
