...
$result = $db->query("select id, url, userid from websites where inSurf = '1' && id = '{$id}' LIMIT 1");
$result = $result->getNext();
$next = $db->query("select id from websites where inSurf = '1' && id > {$id} order by id asc LIMIT 1");
