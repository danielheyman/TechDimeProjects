<?php include 'header.php'; $subscription = 3; $subscription2 = 4; ?>
...
<div class="content">
    ...
    <?php if($usr->data->membership == 0001) { ?>
            ...
            <tr class="odd"><td>It's FREE</td><td><div class="red"><del>$9 per Month</del></div><br>Now only $6.30 per Month</td><td><div class="red"><del>$19 per Month</del></div><br>Now only $13.30 per Month</td></tr>
        <tr class="even">
            <td></td>    
            <td>
                <div class="form">
    ...
    <?php } ?>
        ...
        <br><div class="red">*</div> Required Views Per Day: The amount of daily views you need to get in order for your websites to be active and surfed the next day.<br>
        <br><div class="red">**</div> Views Per Ref View: The amount of views you get for every view a referral makes.<br>
        <?php
