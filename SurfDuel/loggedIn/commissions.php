...
<div class="header">Commissions</div>
<div class="content">
    <?php if($usr->data->membership == 0001) { ?><a href="<?=$site["url"]?>upgrade"><div class="promo">Get 40% commissions as an upgraded member!</div></a><br><?php } ?>
