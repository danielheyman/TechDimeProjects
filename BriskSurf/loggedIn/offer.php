    ...
    <div id="content">
        ...
        <div class="commonFormWrapper">
            ...
            <div class="ribbon-wrapper-green"><div class="ribbon-green">SPECIAL OFFER</div></div>
               <iframe width="640" height="426" src="//www.youtube.com/embed/ZJNeHGAnss8?rel=0&autohide=1&showinfo=0&wmode=transparent&autoplay=1" frameborder="0" allowfullscreen></iframe>
                <h1>Save Over 56% On One Full Year!</h1>
                ...
                <h1>Platinum Membership Now Only $68</h1>
                <div class="box">
                    <h3>
                        ...
                        Now only <font color="c74e4e">$68</font>! An <font color="c74e4e">$88 savings</font> is too good to pass up!
                        <br><br>
                        <?php $subscription = 23; ?>
