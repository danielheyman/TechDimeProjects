...
GROUP BY `userid` HAVING SUM(`amount`) >= 10");
...
if($query->getNumRows())
{
    ...
    {
        if($count != 0) echo "\n";
        echo $row->paypal . "," . $row->amount . ",USD," . $row->userid . ",Here are your BriskSurf earnings. Thank you for your support!";
        $count++;
    }
}
...
echo "</textarea>";
?>
<br><br><a href="payoutCSVMBDH.php"><button>Download</button></a><br>Subject: Here are your BriskSurf earnings. Thank you for your support!<br><br><form method="post"><input name="completePayout" type="submit" value="Complete"/></form>